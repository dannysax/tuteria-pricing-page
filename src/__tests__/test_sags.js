...
test('no of hours should work as expected', () => {
  ...
  expect(calculateHours(3)).toBe(3);
  expect(calculateHours(4)).toBe(4);
...
test('no of students rate work as expected', () => {
  ...
  expect(calculateRate(3)).toBe(1.5);
...
test('total price returns the correct result', () => {
  ...
  expect(determinePrice(2000, 2, 1, 1)).toBe(3200);
  expect(determinePrice(2000, 2, 2, 3)).toBe(15000);
